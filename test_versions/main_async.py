...
if __name__=='__main__':
    ...
    num_proc = int(input("Choose number of processors to use: "))
    ...
    try:    
        ...
        attempts = 10 # reduce for test phase
        ...
        degeneracy_frac = float(sum(mp_results))/float(len(mp_results))
    ...
    print('Degeneracy fraction: '+str(degeneracy_frac)+' of '+str(len(mp_results))+' attempts')
